...
<!-- Are there other UI surfaces or rules that could be affected by this change? What did you test to confirm no regression? -->
...
- [ ] I have tested the fix in a local Obsidian vault.
